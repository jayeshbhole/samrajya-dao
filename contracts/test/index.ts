import { SamrajyaDAO as GovernorContract, RAJToken, Timelock } from "../typechain-types";
...
describe("Governor Flow", async () => {
    ...
    beforeEach(async () => {
        ...
        governor = await ethers.getContract("SamrajyaDAO");
